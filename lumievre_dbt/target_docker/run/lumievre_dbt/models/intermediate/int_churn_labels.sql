  ...
  create or replace view `starlit-gift-504722-c7`.`lumievre_intermediate`.`int_churn_labels`
  OPTIONS()
  as -- Reproduit la méthode par coupure temporelle validée en Phase 1 (ADR-002) :
...
observation as (
    select * from orders where invoice_date < timestamp('2011-06-10')
),
